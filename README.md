...
* [PyCaret](https://github.com/pycaret/pycaret) ⭐ 9,754 | 🐛 6 | 🌐 Python | 📅 2026-04-28 - An open-source, low-code machine learning library in Python.  <img height="20" src="img/R_big.png" alt="R inspired lib">
...
* [mlpack](https://github.com/mlpack/mlpack) ⭐ 5,635 | 🐛 19 | 🌐 C++ | 📅 2026-04-23 - A scalable C++ machine learning library (Python bindings).
* [cuML](https://github.com/rapidsai/cuml) ⭐ 5,183 | 🐛 869 | 🌐 C++ | 📅 2026-04-29 - RAPIDS Machine Learning Library. <img height="20" src="img/sklearn_big.png" alt="sklearn"> <img height="20" src="img/gpu_big.png" alt="GPU accelerated">
* [MLxtend](https://github.com/rasbt/mlxtend) ⭐ 5,135 | 🐛 159 | 🌐 Python | 📅 2026-01-24 - Extension and helper modules for Python's data analysis and machine learning libraries. <img height="20" src="img/sklearn_big.png" alt="sklearn">
...
* [modAL](https://github.com/cosmic-cortex/modAL) ⭐ 2,347 | 🐛 108 | 🌐 Python | 📅 2024-02-26 - Modular active learning framework for Python3. <img height="20" src="img/sklearn_big.png" alt="sklearn">
...
* [XGBoost](https://github.com/dmlc/xgboost) ⭐ 28,328 | 🐛 463 | 🌐 C++ | 📅 2026-04-28 - Scalable, Portable, and Distributed Gradient Boosting. <img height="20" src="img/sklearn_big.png" alt="sklearn"> <img height="20" src="img/gpu_big.png" alt="GPU accelerated">
* [LightGBM](https://github.com/Microsoft/LightGBM) ⭐ 18,303 | 🐛 499 | 🌐 C++ | 📅 2026-04-29 - A fast, distributed, high-performance gradient boosting. <img height="20" src="img/sklearn_big.png" alt="sklearn"> <img height="20" src="img/gpu_big.png" alt="GPU accelerated">
* [CatBoost](https://github.com/catboost/catboost) ⭐ 8,920 | 🐛 694 | 🌐 C++ | 📅 2026-04-29 - An open-source gradient boosting on decision trees library. <img height="20" src="img/sklearn_big.png" alt="sklearn"> <img height="20" src="img/gpu_big.png" alt="GPU accelerated">
...
* [PyTorch](https://github.com/pytorch/pytorch) ⭐ 99,512 | 🐛 18,536 | 🌐 Python | 📅 2026-04-29 - Tensors and Dynamic neural networks in Python with strong GPU acceleration. <img height="20" src="img/pytorch_big2.png" alt="PyTorch based/compatible">
* [pytorch-lightning](https://github.com/Lightning-AI/lightning) ⭐ 31,092 | 🐛 995 | 🌐 Python | 📅 2026-04-29 - PyTorch Lightning is just organized PyTorch. <img height="20" src="img/pytorch_big2.png" alt="PyTorch based/compatible">
* [skorch](https://github.com/dnouri/skorch) ⭐ 6,155 | 🐛 65 | 🌐 Jupyter Notebook | 📅 2026-04-27 - A scikit-learn compatible neural network library that wraps PyTorch. <img height="20" src="img/sklearn_big.png" alt="sklearn"> <img height="20" src="img/pytorch_big2.png" alt="PyTorch based/compatible">
...
* [TensorFlow](https://github.com/tensorflow/tensorflow) ⭐ 194,928 | 🐛 4,765 | 🌐 C++ | 📅 2026-04-29 - Computation using data flow graphs for scalable machine learning by Google. <img height="20" src="img/tf_big2.png" alt="sklearn">
* [Ludwig](https://github.com/uber/ludwig) ⭐ 11,681 | 🐛 7 | 🌐 Python | 📅 2026-04-29 - A toolbox that allows one to train and test deep learning models without the need to write code. <img height="20" src="img/tf_big2.png" alt="sklearn">
* [Sonnet](https://github.com/deepmind/sonnet) ⭐ 9,918 | 🐛 40 | 🌐 Python | 📅 2026-02-10 - TensorFlow-based neural network library. <img height="20" src="img/tf_big2.png" alt="sklearn">
...
* [JAX](https://github.com/google/jax) ⭐ 35,508 | 🐛 2,291 | 🌐 Python | 📅 2026-04-29 - Composable transformations of Python+NumPy programs: differentiate, vectorize, JIT to GPU/TPU, and more.
* [FLAX](https://github.com/google/flax) ⭐ 7,185 | 🐛 478 | 🌐 Jupyter Notebook | 📅 2026-04-28 - A neural network library for JAX that is designed for flexibility.
* [Optax](https://github.com/google-deepmind/optax) ⭐ 2,251 | 🐛 81 | 🌐 Python | 📅 2026-04-28 - A gradient processing and optimization library for JAX.
...
* [transformers](https://github.com/huggingface/transformers) ⭐ 160,070 | 🐛 2,341 | 🌐 Python | 📅 2026-04-28 - State-of-the-art Machine Learning for Pytorch, TensorFlow, and JAX. <img height="20" src="img/pytorch_big2.png" alt="PyTorch based/compatible"> <img height="20" src="img/tf_big2.png" alt="sklearn">
...
* [auto-sklearn](https://github.com/automl/auto-sklearn) ⭐ 8,086 | 🐛 208 | 🌐 Python | 📅 2026-04-21 - An AutoML toolkit and a drop-in replacement for a scikit-learn estimator. <img height="20" src="img/sklearn_big.png" alt="sklearn">
...
* [NLTK](https://github.com/nltk/nltk) ⭐ 14,600 | 🐛 279 | 🌐 Python | 📅 2026-04-28 -  Modules, data sets, and tutorials supporting research and development in Natural Language Processing.
...
* [KerasNLP](https://github.com/keras-team/keras-nlp) ⭐ 976 | 🐛 246 | 🌐 Python | 📅 2026-04-29 - Modular Natural Language Processing workflows with Keras. <img height="20" src="img/keras_big.png" alt="Keras based/compatible">
...
* [librosa](https://github.com/librosa/librosa) ⭐ 8,367 | 🐛 80 | 🌐 Python | 📅 2026-04-28 - Python library for audio and music analysis.
* [aubio](https://github.com/aubio/aubio) ⭐ 3,693 | 🐛 155 | 🌐 C | 📅 2026-04-10 - A library for audio and music analysis.
* [Essentia](https://github.com/MTG/essentia) ⭐ 3,535 | 🐛 416 | 🌐 C++ | 📅 2026-04-16 - Library for audio and music analysis, description, and synthesis.
* [torchaudio](https://github.com/pytorch/audio) ⭐ 2,872 | 🐛 325 | 🌐 Python | 📅 2026-04-28 - An audio library for PyTorch. <img height="20" src="img/pytorch_big2.png" alt="PyTorch based/compatible">
* [madmom](https://github.com/CPJKU/madmom) ⭐ 1,635 | 🐛 79 | 🌐 Python | 📅 2026-03-20 - Python audio and music signal processing library.
...
* [OpenCV](https://github.com/opencv/opencv) ⭐ 87,278 | 🐛 2,739 | 🌐 C++ | 📅 2026-04-28 - Open Source Computer Vision Library.
* [torchvision](https://github.com/pytorch/vision) ⭐ 17,648 | 🐛 1,197 | 🌐 Python | 📅 2026-04-28 - Datasets, Transforms, and Models specific to Computer Vision. <img height="20" src="img/pytorch_big2.png" alt="PyTorch based/compatible">
...
* [scikit-image](https://github.com/scikit-image/scikit-image) ⭐ 6,504 | 🐛 901 | 🌐 Python | 📅 2026-04-28 - Image Processing SciKit (Toolbox for SciPy).
* [Augmentor](https://github.com/mdbloice/Augmentor) ⭐ 5,139 | 🐛 140 | 🌐 Python | 📅 2024-03-21 - Image augmentation library in Python for machine learning.
...
* [MMEngine](https://github.com/open-mmlab/mmengine) ⭐ 1,467 | 🐛 257 | 🌐 Python | 📅 2025-12-23 - OpenMMLab Foundational Library for Training Deep Learning Models. <img height="20" src="img/pytorch_big2.png" alt="PyTorch based/compatible">
...
* [Prophet](https://github.com/facebook/prophet) ⭐ 20,151 | 🐛 460 | 🌐 Python | 📅 2026-04-08 - Automatic Forecasting Procedure.
* [sktime](https://github.com/alan-turing-institute/sktime) ⭐ 9,746 | 🐛 2,242 | 🌐 Python | 📅 2026-04-28 - A unified framework for machine learning with time series. <img height="20" src="img/sklearn_big.png" alt="sklearn">
...
* [neuralforecast](https://github.com/Nixtla/neuralforecast) ⭐ 4,064 | 🐛 65 | 🌐 Python | 📅 2026-04-27 - Scalable machine learning-based time series forecasting.
...
* [skforecast](https://github.com/JoaquinAmatRodrigo/skforecast) ⭐ 1,481 | 🐛 20 | 🌐 Python | 📅 2026-04-28 - Time series forecasting with machine learning models
* [luminol](https://github.com/linkedin/luminol) ⭐ 1,230 | 🐛 35 | 🌐 Python | 📅 2025-08-22 - Anomaly Detection and Correlation library.
* [mlforecast](https://github.com/Nixtla/mlforecast) ⭐ 1,217 | 🐛 13 | 🌐 Python | 📅 2026-04-28 - Scalable machine learning-based time series forecasting.
...
* [Stable Baselines3](https://github.com/DLR-RM/stable-baselines3) ⭐ 13,180 | 🐛 78 | 🌐 Python | 📅 2026-04-19 - A set of improved implementations of reinforcement learning algorithms based on OpenAI Baselines.
* [Gymnasium](https://github.com/Farama-Foundation/Gymnasium) ⭐ 11,801 | 🐛 85 | 🌐 Python | 📅 2026-04-28 - An API standard for single-agent reinforcement learning environments, with popular reference environments and related utilities (formerly [Gym](https://github.com/openai/gym) ⚠️ Archived).
...
* [Tianshou](https://github.com/thu-ml/tianshou/#comprehensive-functionality) ⭐ 10,613 | 🐛 137 | 🌐 Python | 📅 2026-04-03 - An elegant PyTorch deep reinforcement learning library. <img height="20" src="img/pytorch_big2.png" alt="PyTorch based/compatible">
* [cleanrl](https://github.com/vwxyzjn/cleanrl) ⭐ 9,653 | 🐛 98 | 🌐 Python | 📅 2026-04-20 - High-quality single file implementation of Deep Reinforcement Learning algorithms with research-friendly features (PPO, DQN, C51, DDPG, TD3, SAC, PPG).
...
* [Acme](https://github.com/google-deepmind/acme) ⭐ 3,976 | 🐛 97 | 🌐 Python | 📅 2026-04-08 - A library of reinforcement learning components and agents.
* [Horizon](https://github.com/facebookresearch/Horizon) ⭐ 3,697 | 🐛 85 | 🌐 Python | 📅 2026-04-26 - A platform for Applied Reinforcement Learning.
...
* [TF-Agents](https://github.com/tensorflow/agents) ⭐ 3,008 | 🐛 211 | 🌐 Python | 📅 2026-01-16 - A library for Reinforcement Learning in TensorFlow. <img height="20" src="img/tf_big2.png" alt="TensorFlow">
...
* [pytorch\_geometric](https://github.com/rusty1s/pytorch_geometric) ⭐ 23,705 | 🐛 1,265 | 🌐 Python | 📅 2026-04-18 - Geometric Deep Learning Extension Library for PyTorch. <img height="20" src="img/pytorch_big2.png" alt="PyTorch based/compatible">
* [TRL](https://github.com/huggingface/trl) ⭐ 18,199 | 🐛 693 | 🌐 Python | 📅 2026-04-29 - Train transformer language models with reinforcement learning.
...
* [Networkx](https://github.com/networkx/networkx) ⭐ 16,860 | 🐛 333 | 🌐 Python | 📅 2026-04-27 - Network Analysis in Python.
...
* [Surprise](https://github.com/NicolasHug/Surprise) ⭐ 6,776 | 🐛 93 | 🌐 Python | 📅 2025-07-24 - A Python scikit for building and analyzing recommender systems.
* [LightFM](https://github.com/lyst/lightfm) ⭐ 5,080 | 🐛 165 | 🌐 Python | 📅 2024-07-24 - A Python implementation of LightFM, a hybrid recommendation algorithm.
* [RecBole](https://github.com/RUCAIBox/RecBole) ⭐ 4,408 | 🐛 358 | 🌐 Python | 📅 2025-02-24 - A unified, comprehensive and efficient recommendation library. <img height="20" src="img/pytorch_big2.png" alt="PyTorch based/compatible">
...
* [pomegranate](https://github.com/jmschrei/pomegranate) ⭐ 3,524 | 🐛 42 | 🌐 Python | 📅 2025-03-06 - Probabilistic and graphical models for Python. <img height="20" src="img/pytorch_big2.png" alt="PyTorch based/compatible">
...
* [PyMC](https://github.com/pymc-devs/pymc) ⭐ 9,601 | 🐛 492 | 🌐 Python | 📅 2026-04-27 - Bayesian Stochastic Modelling in Python.
* [pyro](https://github.com/uber/pyro) ⭐ 8,995 | 🐛 275 | 🌐 Python | 📅 2025-07-09 - A flexible, scalable deep probabilistic programming library built on PyTorch. <img height="20" src="img/pytorch_big2.png" alt="PyTorch based/compatible">
...
* [Netron](https://github.com/lutzroeder/Netron) ⭐ 32,817 | 🐛 19 | 🌐 JavaScript | 📅 2026-04-28 - Visualizer for deep learning and machine learning models (no Python code, but visualizes models from most Python Deep Learning frameworks).
* [shap](https://github.com/slundberg/shap) ⭐ 25,359 | 🐛 961 | 🌐 Jupyter Notebook | 📅 2026-04-28 - A unified approach to explain the output of any machine learning model. <img height="20" src="img/sklearn_big.png" alt="sklearn">
...
* [DEAP](https://github.com/DEAP/deap) ⭐ 6,382 | 🐛 282 | 🌐 Python | 📅 2026-04-17 - Distributed Evolutionary Algorithms in Python.
* [PyGAD](https://github.com/ahmedfgad/GeneticAlgorithmPython) ⭐ 2,192 | 🐛 103 | 🌐 Python | 📅 2026-04-21 - Genetic Algorithm in Python. <img height="20" src="img/pytorch_big2.png" alt="PyTorch based/compatible"> <img height="20" src="img/keras_big.png" alt="keras">
...
* [Optuna](https://github.com/optuna/optuna) ⭐ 14,065 | 🐛 25 | 🌐 Python | 📅 2026-04-28 - A hyperparameter optimization framework.
* [Bayesian Optimization](https://github.com/fmfn/BayesianOptimization) ⭐ 8,615 | 🐛 6 | 🌐 Python | 📅 2026-04-01 - A Python implementation of global optimization with gaussian processes.
...
* [scikit-opt](https://github.com/guofei9987/scikit-opt) ⭐ 6,502 | 🐛 70 | 🌐 Python | 📅 2026-03-25 - Heuristic Algorithms for optimization.
* [BoTorch](https://github.com/pytorch/botorch) ⭐ 3,513 | 🐛 95 | 🌐 Jupyter Notebook | 📅 2026-04-28 - Bayesian optimization in PyTorch. <img height="20" src="img/pytorch_big2.png" alt="PyTorch based/compatible">
* [pymoo](https://github.com/anyoptimization/pymoo) ⭐ 2,853 | 🐛 17 | 🌐 Python | 📅 2026-02-22 - Multi-objective Optimization in Python.
...
* [nlopt](https://github.com/stevengj/nlopt) ⭐ 2,208 | 🐛 100 | 🌐 C | 📅 2026-03-13 - Library for nonlinear optimization (global and local, constrained or unconstrained).
...
* [pycma](https://github.com/CMA-ES/pycma?tab=readme-ov-file) ⭐ 1,307 | 🐛 90 | 🌐 Jupyter Notebook | 📅 2026-02-25 - Python implementation of CMA-ES.
...
* [tsfresh](https://github.com/blue-yonder/tsfresh) ⭐ 9,179 | 🐛 73 | 🌐 Jupyter Notebook | 📅 2025-11-15 - Automatic extraction of relevant features from time series. <img height="20" src="img/sklearn_big.png" alt="sklearn">
* [Featuretools](https://github.com/Featuretools/featuretools) ⭐ 7,630 | 🐛 162 | 🌐 Python | 📅 2026-02-03 - Automated feature engineering.
...
* [tubular](https://github.com/azukds/tubular) ⭐ 100 | 🐛 77 | 🌐 Python | 📅 2026-04-27 - Collection of scikit-learn compatible transformers written in [narwhals](https://github.com/narwhals-dev/narwhals) ⭐ 1,598 | 🐛 210 | 🌐 Python | 📅 2026-04-28, which can accept either polars/pandas inputs and utilise the chosen library under the hood. <img height="20" src="img/sklearn_big.png" alt="sklearn"><img height="20" src="img/pandas_big.png" alt="pandas compatible">
...
* [Matplotlib](https://github.com/matplotlib/matplotlib) ⭐ 22,751 | 🐛 1,501 | 🌐 Python | 📅 2026-04-28 - Plotting with Python.
* [seaborn](https://github.com/mwaskom/seaborn) ⭐ 13,830 | 🐛 216 | 🌐 Python | 📅 2026-01-22 - Statistical data visualization using matplotlib.
...
* [pyecharts](https://github.com/pyecharts/pyecharts) ⭐ 15,753 | 🐛 3 | 🌐 Python | 📅 2026-04-14 - Migrated from [Echarts](https://github.com/apache/echarts) ⭐ 66,250 | 🐛 1,689 | 🌐 TypeScript | 📅 2026-04-27, a charting and visualization library, to Python's interactive visual drawing library.<img height="20" src="img/pyecharts.png" alt="pyecharts"> <img height="20" src="img/echarts.png" alt="echarts">
* [bqplot](https://github.com/bqplot/bqplot) ⭐ 3,688 | 🐛 278 | 🌐 TypeScript | 📅 2026-04-28 - Plotting library for IPython/Jupyter notebooks
...
* [geemap](https://github.com/giswqs/geemap) ⭐ 3,935 | 🐛 35 | 🌐 Python | 📅 2026-04-28 - Python package for interactive mapping with Google Earth Engine (GEE)
...
* [HoloViews](https://github.com/ioam/holoviews) ⭐ 2,891 | 🐛 1,068 | 🌐 Python | 📅 2026-04-28 - Stop plotting your data - annotate your data and let it visualize itself.
...
* [gradio](https://github.com/gradio-app/gradio) ⭐ 42,458 | 🐛 460 | 🌐 Python | 📅 2026-04-28 - Create UIs for your machine learning model in Python in 3 minutes.
* [Vizro](https://github.com/mckinsey/vizro) ⭐ 3,674 | 🐛 72 | 🌐 Python | 📅 2026-04-29 - A toolkit for creating modular data visualization applications.
...
* [stockstats](https://github.com/jealous/stockstats) ⭐ 1,460 | 🐛 15 | 🌐 Python | 📅 2026-03-30 - Supply a wrapper `StockDataFrame` based on the `pandas.DataFrame` with inline stock statistics/indicators support.
...
* [polars](https://github.com/pola-rs/polars) ⭐ 38,330 | 🐛 2,747 | 🌐 Rust | 📅 2026-04-28 - A fast multi-threaded, hybrid-out-of-core DataFrame library.
...
* [cuDF](https://github.com/rapidsai/cudf) ⭐ 9,613 | 🐛 1,250 | 🌐 C++ | 📅 2026-04-29 - GPU DataFrame Library. <img height="20" src="img/pandas_big.png" alt="pandas compatible"> <img height="20" src="img/gpu_big.png" alt="GPU accelerated">
...
* [xarray](https://github.com/pydata/xarray) ⭐ 4,143 | 🐛 1,348 | 🌐 Python | 📅 2026-04-28 - Xarray combines the best features of NumPy and pandas for multidimensional data selection by supplementing numerical axis labels with named dimensions for more intuitive, concise, and less error-prone indexing routines.
...
* [Hamilton](https://github.com/DAGWorks-Inc/hamilton) ⭐ 2,464 | 🐛 156 | 🌐 Jupyter Notebook | 📅 2026-04-26 - A microframework for dataframe generation that applies Directed Acyclic Graphs specified by a flow of lazily evaluated Python functions.
...
* [ydata-synthetic](https://github.com/ydataai/ydata-synthetic) ⭐ 1,629 | 🐛 65 | 🌐 Jupyter Notebook | 📅 2026-04-23 - A package to generate synthetic tabular and time-series data leveraging the state-of-the-art generative models. <img height="20" src="img/pandas_big.png" alt="pandas compatible">

## Distributed Computing

* [PaddlePaddle](https://github.com/PaddlePaddle/Paddle) ⭐ 23,863 | 🐛 1,494 | 🌐 C++ | 📅 2026-04-29 - PArallel Distributed Deep LEarning.
...
* [Distributed](https://github.com/dask/distributed) ⭐ 1,669 | 🐛 1,513 | 🌐 Python | 📅 2026-04-28 - Distributed computation in Python.
...
* [mlflow](https://github.com/mlflow/mlflow) ⭐ 25,620 | 🐛 2,040 | 🌐 Python | 📅 2026-04-29 - Open source platform for the machine learning lifecycle.
* [dvc](https://github.com/iterative/dvc) ⭐ 15,572 | 🐛 169 | 🌐 Python | 📅 2026-04-28 - Data Version Control | Git for Data & Models | ML Experiments Management.
...
* [Ax](https://github.com/facebook/Ax) ⭐ 2,740 | 🐛 193 | 🌐 Python | 📅 2026-04-28 - Adaptive Experimentation Platform. <img height="20" src="img/sklearn_big.png" alt="sklearn">
* [envd](https://github.com/tensorchord/envd) ⭐ 2,199 | 🐛 130 | 🌐 Go | 📅 2026-04-25 - 🏕️ machine learning development environment for data science and AI/ML engineering teams.
* [Neptune](https://neptune.ai) - A lightweight ML experiment tracking, results visualization, and management tool.

## Data Validation

* [great\_expectations](https://github.com/great-expectations/great_expectations) ⭐ 11,449 | 🐛 53 | 🌐 Python | 📅 2026-04-23 - Always know what to expect from your data.
* [evidently](https://github.com/evidentlyai/evidently) ⭐ 7,432 | 🐛 271 | 🌐 Jupyter Notebook | 📅 2026-04-22 - Evaluate and monitor ML models from validation to production.
* [pandera](https://github.com/unionai-oss/pandera) ⭐ 4,316 | 🐛 452 | 🌐 Python | 📅 2026-04-29 - A lightweight, flexible, and expressive statistical data testing library.
...
* [CuPy](https://github.com/cupy/cupy) ⭐ 10,918 | 🐛 668 | 🌐 Python | 📅 2026-04-28 - NumPy-like API accelerated with CUDA.
* [NumExpr](https://github.com/pydata/numexpr) ⭐ 2,414 | 🐛 2 | 🌐 Python | 📅 2026-04-27 - A fast numerical expression evaluator for NumPy that comes with an integrated computing virtual machine to speed calculations up by avoiding memory allocation for intermediate results.
...
* [GeoPandas](https://github.com/geopandas/geopandas) ⭐ 5,111 | 🐛 419 | 🌐 Python | 📅 2026-04-13 - Python tools for geographic data. <img height="20" src="img/pandas_big.png" alt="pandas compatible">
* [PySal](https://github.com/pysal/pysal) ⭐ 1,495 | 🐛 23 | 🌐 Python | 📅 2026-04-15 - Python Spatial Analysis Library.

## Quantum Computing

* [qiskit](https://github.com/Qiskit/qiskit) ⭐ 7,318 | 🐛 1,149 | 🌐 Python | 📅 2026-04-29 - Qiskit is an open-source SDK for working with quantum computers at the level of circuits, algorithms, and application modules.
* [cirq](https://github.com/quantumlib/Cirq) ⭐ 4,946 | 🐛 119 | 🌐 Python | 📅 2026-04-28 - A python framework for creating, editing, and invoking Noisy Intermediate Scale Quantum (NISQ) circuits.
* [PennyLane](https://github.com/XanaduAI/pennylane) ⭐ 3,182 | 🐛 341 | 🌐 Python | 📅 2026-04-28 - Quantum machine learning, automatic differentiation, and optimization of hybrid quantum-classical computations.
* [QML](https://github.com/qmlcode/qml) ⚠️ Archived - A Python Toolkit for Quantum Machine Learning.

## Conversion

* [ONNX](https://github.com/onnx/onnx) ⭐ 20,732 | 🐛 322 | 🌐 Python | 📅 2026-04-29 - Open Neural Network Exchange.
...
* [treelite](https://github.com/dmlc/treelite) ⭐ 813 | 🐛 15 | 🌐 C++ | 📅 2026-04-27 - Universal model exchange and serialization format for decision tree forests.

## Contributing

Contributions are welcome! :sunglasses: </br>
Read the \<a href=[https://github.com/krzjoa/awesome-python-datascience/blob/master/CONTRIBUTING.md>contribution](https://github.com/krzjoa/awesome-python-datascience/blob/master/CONTRIBUTING.md>contribution) ⭐ 3,406 | 🐛 7 | 📅 2026-04-13 guideline</a>.
